...
class DDSOutput(QWidget):
    def __init__(self, hardware_name, connection_name='-', parent=None):
        ...
        self._widgets['length'] = AnalogOutput('',display_name='length', horizontal_alignment=True)
        self._widgets['rate'] = AnalogOutput('',display_name='rate', horizontal_alignment=True)
        self._widgets['deviation'] = AnalogOutput('',display_name='deviation', horizontal_alignment=True)
        ...
        self._widgets['length'].setToolTip("Length")
        self._widgets['rate'].setToolTip("rate")
        self._widgets['deviation'].setToolTip("deviation")
        ...
        v_layout.addWidget(self._widgets['length'])
        v_layout.addWidget(self._widgets['rate'])
        v_layout.addWidget(self._widgets['deviation'])
