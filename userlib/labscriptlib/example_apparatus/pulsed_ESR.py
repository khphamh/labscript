...
start()
#dt = 5e-3
counter_gate_time = 4000e-9
counter.fast_counter(1e8, 2, 1)
Piezo.setamp(t, 50)
SRSDDS.setamp(t, pulsed_SRS_amp)
SRSDDS.setfreq(t, pulsed_freq_center)
SRSDDS.enable_mod(t)
SRSDDS.enable_IQ(t)
...
ZCUDDS.add_pulse(5,'buffer',1e-6, 4000, 32766,100,0,'oneshot','product','[]') #channel, mode, start time, pulse length, gain, frequency, phase, _, _, _ 
ZCUDDS.add_pulse(6,'buffer',1e-6, 4000, 32766,100,90,'oneshot','product','[]') #channel, mode, start time, pulse length, gain, frequency, phase, _, _, _  
