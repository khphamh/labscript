...
class NI_DAQmx(IntermediateDevice):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.allowed_children = [CounterIn]
    ...
    def _make_counter_input_table(self, inputs): #EE8
    ...
    def generate_code(self, hdf5_file):
        ...
        for device in self.child_devices:
            ...
            elif isinstance(device, CounterIn):
        ...
        # CI_table = self._make_counter_input_table(inputs)  #EE8
        #print(counter_inputs)
        counter_connections = list(counter_inputs.keys())
        #print('counter_connections', counter_connections)
        ...
        for connection in counter_connections:
            ...
            if len(counter_inputs[connection].acquisitions) > 1:
        ...
        if len(CI_table): # Table must be non empty
