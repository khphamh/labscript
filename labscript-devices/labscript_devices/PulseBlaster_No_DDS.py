...
class PulseBlaster_No_DDS(PulseBlaster):
    ...
    def write_pb_inst_to_h5(self, pb_inst, hdf5_file):
        ...
        pb_dtype= [('flags',np.int32), ('inst',np.int32), ('inst_data',np.int32), ('length',np.float64), ('loop_number',np.int32), ('extra_flags', np.int32), ('extra_inst',np.int32), ('extra_inst_data',np.int32), ('extra_length',np.float64), ('additional_inst',np.int32)]
        ...
        for i,inst in enumerate(pb_inst):
            ...
            pb_inst_table[i] = (flagint, instructionint, dataint, delaydouble, loops, extra_flags, extra_inst, extra_inst_data, extra_length, additional_inst)
    ...
    def transition_to_buffered(self,device_name,h5file,initial_values,fresh):
        ...
        with h5py.File(h5file,'r') as hdf5_file:
            ...
            if pulse_program[0][3] > 10:
                ...
                for i in range(1, len(pulse_program)-4-pulse_program[0][-1]):
                    #self.logger.info(i)
                    pulse_program[i][1] = 0
                pulse_program[0][2] = pulse_program[0][4]
            ...
            flags,z,z,z,z,z,z,z,z,z = pulse_program[-1]
